                            ...
                            {profile?.permission &&
                                    <div className="flex flex-row space-x-2 sm:space-x-3 items-center">
                                        <Link href="/writing/new"
                                            className="w-8 h-8 sm:w-auto sm:h-auto px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium transition-all flex items-center justify-center sm:justify-start shadow-sm bg-theme text-white hover:bg-theme-dark">
